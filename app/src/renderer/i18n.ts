...
export const messages: Record<Locale, Record<string, string>> = {
	ja: {
		...
		"confirm.removeMaterialBody": "この素材を一覧から削除します。解析結果もリセットされます。",
		"confirm.removeMissingMaterialTitle": "不在ファイルを削除",
		"confirm.removeMissingMaterialBody": "この素材を一覧から削除します。解析結果もリセットされます。",
	...
	en: {
		...
		"confirm.removeMaterialBody": "This asset will be removed from the list and analysis results will be reset.",
		"confirm.removeMissingMaterialTitle": "Remove missing file",
		"confirm.removeMissingMaterialBody": "This asset will be removed from the list and analysis results will be reset.",
