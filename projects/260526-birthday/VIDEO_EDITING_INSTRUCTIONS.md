...
- The preview output is generated by `scripts/build_event_highlight.py`.
- Use preview mode for lightweight review output:

```powershell
python .\scripts\build_event_highlight.py --project-root 'C:\Users\yurin\Desktop\video_edit\projects\260526-birthday' --preview --target-seconds 900 --base-image-seconds 4 --background-audio auto --force --jobs 2
```
