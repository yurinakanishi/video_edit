...
def main() -> None:
    ...
    for ref in refs:
        ...
        analysis = {
            ...
            "caption_style": {
                "text_color": "#FFFFFF",
                "font_family": "BIZ UDGothic Bold / Japanese heavy sans-serif",
                "font_weight": "heavy_bold",
                "black_stroke": False,
                "shadow": "none or extremely subtle; no visible black outline",
                "font_size_ratio_to_720p_height": 0.131,
                "target_font_size_720p": 94,
                "min_font_size_720p": 70,
                "horizontal_condense": 0.92,
                "line_height_720p": 106,
                "inter_line_gap_720p": 6,
                "box_padding_x_720p": 31,
                "box_padding_y_720p": 10,
                "box_radius_720p": 5,
                "box_gradient": {
